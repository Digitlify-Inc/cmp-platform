...
/**
 * Assigns marketplace's navigation menus.
 *
...
export type Attribute = Node &
	ObjectWithMetadata & {
		...
		/**
		 * Whether the attribute can be filtered in marketplace. Requires one of the following permissions: MANAGE_PAGES, MANAGE_PAGE_TYPES_AND_ATTRIBUTES, MANAGE_PRODUCTS, MANAGE_PRODUCT_TYPES_AND_ATTRIBUTES.
		 * @deprecated This field will be removed in Saleor 4.0.
		 */
		filterableInmarketplace: Scalars["Boolean"];
		id: Scalars["ID"];
		...
		/**
		 * The position of the attribute in the marketplace navigation (0 by default). Requires one of the following permissions: MANAGE_PAGES, MANAGE_PAGE_TYPES_AND_ATTRIBUTES, MANAGE_PRODUCTS, MANAGE_PRODUCT_TYPES_AND_ATTRIBUTES.
		 * @deprecated This field will be removed in Saleor 4.0.
		 */
		marketplaceSearchPosition: Scalars["Int"];
		...
		/** Whether the attribute should be visible or not in marketplace. Requires one of the following permissions: MANAGE_PAGES, MANAGE_PAGE_TYPES_AND_ATTRIBUTES, MANAGE_PRODUCTS, MANAGE_PRODUCT_TYPES_AND_ATTRIBUTES. */
		visibleInmarketplace: Scalars["Boolean"];
...
export type AttributeCreateInput = {
	...
	/**
	 * Whether the attribute can be filtered in marketplace.
	 *
	 * DEPRECATED: this field will be removed in Saleor 4.0.
	 */
	filterableInmarketplace?: InputMaybe<Scalars["Boolean"]>;
	/** The input type to use for entering attribute values in the dashboard. */
	...
	/**
	 * The position of the attribute in the marketplace navigation (0 by default).
	 *
	 * DEPRECATED: this field will be removed in Saleor 4.0.
	 */
	marketplaceSearchPosition?: InputMaybe<Scalars["Int"]>;
	/** The attribute type. */
	...
	/** Whether the attribute should be visible or not in marketplace. */
	visibleInmarketplace?: InputMaybe<Scalars["Boolean"]>;
};
...
export type AttributeSortField =
	...
	/** Sort attributes by the filterable in marketplace flag */
	| "FILTERABLE_IN_marketplace"
	...
	| "SLUG"
	/** Sort attributes by their position in marketplace */
	| "marketplace_SEARCH_POSITION"
	/** Sort attributes by the value required flag */
	| "VALUE_REQUIRED"
	/** Sort attributes by visibility in the marketplace */
...
/** Represents a single category of products. Categories allow to organize products in a tree-hierarchies which can be used for navigation in the marketplace. */
...
export type Checkout = Node &
	ObjectWithMetadata & {
		...
		/**
		 * Determines whether checkout prices should include taxes when displayed in a marketplace.
		 *
		 * Added in Saleor 3.9.
		 *
		 * Note: this API is currently in Feature Preview and can be subject to changes at later point.
...
export type PageCreateInput = {
	...
	/** Determines if page is visible in the marketplace. */
	isPublished?: InputMaybe<Scalars["Boolean"]>;
...
export type PaymentGatewayInitializeSession = Event & {
	...
	/** Payment gateway data in JSON format, recieved from marketplace. */
	data?: Maybe<Scalars["JSON"]>;
	/** Time of the event. */
	issuedAt?: Maybe<Scalars["DateTime"]>;
	/** The user or application that triggered the event. */
...
export type PaymentInput = {
	 ...
	 */
	metadata?: InputMaybe<Array<MetadataInput>>;
	/** URL of a marketplace view where user should be redirected after requiring additional actions. Payment with additional actions will not be finished if this field is not provided. */
...
/** Represents an individual item for sale in the marketplace. */
export type Product = Node &
	ObjectWithMetadata & {
		...
		metafields?: Maybe<Scalars["Metadata"]>;
		name: Scalars["String"];
		/** Lists the marketplace product's pricing, the current price and discounts, only meant for displaying. */
...
/** Represents availability of a product in the marketplace. */
export type ProductPricingInfo = {
	...
	/**
	 * Determines whether this product's price displayed in a marketplace should include taxes.
	 *
	 * Added in Saleor 3.9.
	 *
	 * Note: this API is currently in Feature Preview and can be subject to changes at later point.
...
export type ProductVariant = Node &
	ObjectWithMetadata & {
		...
		/** Lists the marketplace variant's pricing, the current price and discounts, only meant for displaying. */
...
export type Query = {
	...
	menuItem?: Maybe<MenuItem>;
	/** List of the marketplaces's menu items. */
	menuItems?: Maybe<MenuItemCountableConnection>;
	/** List of the marketplace's menus. */
...
export type TaxConfiguration = Node &
	ObjectWithMetadata & {
		...
		/** Determines whether prices displayed in a marketplace should include taxes. */
		displayGrossPrices: Scalars["Boolean"];
		/** The ID of the object. */
		id: Scalars["ID"];
		/** List of public metadata items. Can be accessed without permissions. */
...
export type TaxConfigurationPerCountry = {
	...
	country: CountryDisplay;
	/** Determines whether prices displayed in a marketplace should include taxes for this country. */
	displayGrossPrices: Scalars["Boolean"];
...
/** Represents availability of a variant in the marketplace. */
